import CreatePlaylistModal from '@/components/Overlay/Modals/MultiUploadModal/CreatePlaylist';
import UploadSong from '@/components/Overlay/Modals/MultiUploadModal/UploadSong';
  ...
  return (
    <Dialog.Root open={isOpen} defaultOpen={isOpen} onOpenChange={onChange}>
      <Dialog.Portal className="">
        ...
        <Dialog.Content className="fixed left-[50%] top-[50%] h-full max-h-full w-full translate-x-[-50%] translate-y-[-50%] overflow-auto rounded-md border border-neutral-700 bg-neutral-800 p-[25px] drop-shadow-md focus:outline-none md:h-auto md:max-h-[85vh] md:w-[90vw] md:max-w-[450px]">
          <Tabs.Root
