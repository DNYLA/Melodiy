...
const buttonVariants = cva(
  'w-full rounded-full border transition border-transparent hover:opacity-75 disabled:cursor-not-allowed disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
        ...
        alternative: 'bg-primary font-bold text-black',
      },
      size: {
        default: 'px-3 py-2',
        lg: 'px-6 py-2',
