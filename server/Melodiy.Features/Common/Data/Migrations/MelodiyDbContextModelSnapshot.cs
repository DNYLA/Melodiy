...
namespace Melodiy.Features.Common.Data.Migrations
{
    ...
    {
        /// <summary>
        /// Builds the EF Core model used by the migration snapshot for MelodiyDbContext.
        /// </summary>
        /// <param name="modelBuilder">The ModelBuilder used to configure entities, keys, indexes, relationships, and provider-specific annotations for the snapshot.</param>
