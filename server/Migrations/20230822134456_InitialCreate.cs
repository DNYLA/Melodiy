    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Playlists", x => x.UID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    PlaylistUID = table.Column<string>(type: "text", nullable: false),
                    SongUID = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PlaylistSongs_Playlists_PlaylistUID",
                        column: x => x.PlaylistUID,
                        principalTable: "Playlists",
                        principalColumn: "UID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlaylistSongs_Songs_SongUID",
                        column: x => x.SongUID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlaylistSongs_PlaylistUID",
                table: "PlaylistSongs",
                column: "PlaylistUID");

            migrationBuilder.CreateIndex(
                name: "IX_PlaylistSongs_SongUID",
                table: "PlaylistSongs",
                column: "SongUID");
